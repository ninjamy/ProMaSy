...
class TaskTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post task_types_url, params: { task_type: { EditLabel: @task_type.EditLabel, PortID: @task_type.PortID, TaskType: @task_type.TaskType, isActive: @task_type.isActive } }
    end
  ...
  test "should update task_type" do
    patch task_type_url(@task_type), params: { task_type: { EditLabel: @task_type.EditLabel, PortID: @task_type.PortID, TaskType: @task_type.TaskType, isActive: @task_type.isActive } }
