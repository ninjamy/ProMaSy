...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { EditLabel: @stage.EditLabel, PortID: @stage.PortID, StageName: @stage.StageName, StageOrder: @stage.StageOrder, isActive: @stage.isActive } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { EditLabel: @stage.EditLabel, PortID: @stage.PortID, StageName: @stage.StageName, StageOrder: @stage.StageOrder, isActive: @stage.isActive } }
