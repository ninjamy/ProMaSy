...
class TaskStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_status" do
    assert_difference('TaskStatus.count') do
      post task_statuses_url, params: { task_status: { PortID: @task_status.PortID, TaskStatus: @task_status.TaskStatus } }
    end
  ...
  test "should update task_status" do
    patch task_status_url(@task_status), params: { task_status: { PortID: @task_status.PortID, TaskStatus: @task_status.TaskStatus } }
