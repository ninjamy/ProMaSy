...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { EnvironmentName: @environment.EnvironmentName, PortID: @environment.PortID } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { EnvironmentName: @environment.EnvironmentName, PortID: @environment.PortID } }
